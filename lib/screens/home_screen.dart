...
//       {'icon': Icons.camera_alt, 'label': 'Classify Waste', 'onTap': _openWasteClassification},
//       {'icon': Icons.event, 'label': 'Create Event', 'onTap': () => _onServiceItemTapped('Events')},
//       {'icon': Icons.help_outline, 'label': 'FAQ', 'onTap': () => _onServiceItemTapped('FAQ')},
//       {'icon': Icons.local_shipping, 'label': 'Request Pickup', 'onTap': () => _onServiceItemTapped('On Demand Pickup')},
//     ];
//
//     return Container(
//       height: 100,
...
//       {'icon': Icons.location_pin, 'label': 'Map'},
//       {'icon': Icons.payment, 'label': 'Payment'},
//       {'icon': Icons.person, 'label': 'Profile'},
//       {'icon': Icons.book, 'label': 'Dictionary'},
//     ];
//
//     return Card(
//       elevation: 8,
...
//               _buildNavBarItem(Icons.location_on_rounded, 'Map', 1),
//               SizedBox(width: 60),
//               _buildNavBarItem(Icons.history_rounded, 'History', 2),
...
import 'faq.dart';
import 'dictionary.dart';
import 'recycling_center.dart'; // Add this import
